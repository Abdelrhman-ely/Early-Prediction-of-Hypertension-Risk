...
import pandas as pd
import numpy as np
import os  # لتحديد المسار الديناميكي للملف

# ---------------------------
# Load Pipeline
# ---------------------------
BASE_DIR = os.path.dirname(__file__)  # path للمجلد اللي فيه App.py
pipeline_path = os.path.join(BASE_DIR, "xgb_pipeline.pkl")  # تعديل المسار الديناميكي
